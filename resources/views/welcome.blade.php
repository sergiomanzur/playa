                            ...
                            <div class="flex items-center">
                                @if (Route::has('login'))
                                    <div class="px-6 py-4 sm:block">
                                        @auth
                                            <a href="{{ url('/dashboard') }}" class="text-lg text-gray-700 dark:text-gray-500 underline">Panel</a>
                                        @else
                                            <a href="{{ route('login') }}" class="text-lg text-gray-700 dark:text-gray-500 underline">Iniciar Sesión</a>

{{--                                            @if (Route::has('register'))--}}
{{--                                                <a href="{{ route('register') }}" class="ml-4 text-lg text-gray-700 dark:text-gray-500 underline">Registro</a>--}}
{{--                                            @endif--}}
                                        @endauth
                                    </div>
                                @endif
